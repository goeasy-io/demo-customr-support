<template>
    <div class="chat-container">
                        ...
                        <div v-else class="message-item-content" :class="{ self: message.senderId !== customer.id }">
                            ...
                            <div class="message-content">
                                <div class="message-payload">
                                    ...
                                    >
                                        <img :style="{height:getImageHeight(message.payload.width,message.payload.height)+'px'}"
            ...
            <div v-else class="action-box">
                <div class="action-bar">
                    <div class="chat-action">
                        ...
                        <div class="action-item">
                            <div v-if="orderList.visible" class="link-box">
                                <div class="order-item" v-for="(order, index) in orderList.orders" :key="index"
                    ...
                    <div class="session-action">
                        <span @click="showTransferForm()" class="transfer">转接</span>
        ...
        <div class="image-preview" v-if="imagePopup.visible">
